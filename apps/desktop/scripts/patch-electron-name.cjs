 ...
 * - Shows "Navigator" instead of "Electron" in macOS Cmd+Tab and Dock
 * - Registers the "navigator://" URL scheme so OAuth callbacks route to the running dev instance
 */
const fs = require('fs');
const path = require('path');

const APP_NAME = 'Navigator';
const URL_SCHEME = 'navigator';
...
// Add CFBundleURLTypes for the navigator:// protocol (if not already present)
