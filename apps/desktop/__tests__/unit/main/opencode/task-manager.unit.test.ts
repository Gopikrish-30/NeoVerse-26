...
import type { TaskManagerOptions } from '@navigator_ai/agent-core';
...
// Mock @navigator_ai/agent-core module - this is where OpenCodeAdapter and TaskManager actually live
