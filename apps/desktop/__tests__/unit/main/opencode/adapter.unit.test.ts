...
// Mock @navigator_ai/agent-core - agent-core package exports used by adapter
...
describe('OpenCode Adapter Module', () => {
  ...
  beforeEach(async () => {
    ...
    // OpenCodeAdapter is now internal to agent-core, get it from the mocked @navigator_ai/agent-core module
    const agentCoreModule = await import('@navigator_ai/agent-core');
