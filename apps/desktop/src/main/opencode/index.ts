...
export { OpenCodeCliNotFoundError, createTaskManager } from '@navigator_ai/agent-core';
...
import { createTaskManager, type TaskManagerAPI } from '@navigator_ai/agent-core';
import {
  createElectronTaskManagerOptions,
  isCliAvailable,
  getBundledOpenCodeVersion,
