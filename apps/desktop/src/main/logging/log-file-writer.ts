 ...
 * platform-agnostic LogFileWriter from @navigator/core.
 */

import path from 'path';
import { app } from 'electron';
import { createLogWriter, type LogWriterAPI } from '@navigator_ai/agent-core';

// Re-export types from shared package for backward compatibility
export type { LogLevel, LogSource, LogEntry } from '@navigator_ai/agent-core';
