...
describe('ConfigGenerator', () => {
  ...
  describe('NAVIGATOR_AGENT_NAME', () => {
    it('should be "navigator"', () => {
  ...
  describe('generateConfig', () => {
    ...
    it('should set default agent to navigator', () => {
      const options: ConfigGeneratorOptions = {
        ...baseOptions,
        mcpToolsPath,
        userDataPath,
      ...
      expect(result.config.default_agent).toBe(NAVIGATOR_AGENT_NAME);
    });
    ...
    it('should configure agent with correct mode', () => {
      ...
      expect(result.config.agent?.[NAVIGATOR_AGENT_NAME]?.mode).toBe('primary');
    });
  ...
  describe('system prompt content', () => {
    it('should include identity section', () => {
      ...
      expect(result.systemPrompt).toContain('Navigator');
    });
