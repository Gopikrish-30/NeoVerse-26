...
export function TaskInputBar({
  ...
  useEffect(() => {
    if (onSpeechConfigChanged) {
      speechInput.recheckConfiguration();
    }
  }, [onSpeechConfigChanged]); // eslint-disable-line react-hooks/exhaustive-deps -- recheck only on prop change
  ...
  return (
    <div className="w-full space-y-2">
      ...
      <div
        className="rounded-[12px] border border-border bg-popover/70 transition-all duration-200 ease-navigator cursor-text focus-within:border-muted-foreground/40"
